...
const Cart = ({ selectedCourse, remaining, totalCost, totalPrice}) => {
	...
	<h2 className="text-3xl text-center font-bold">Course Cart </h2>
	...
	<div className="p-4 mt-2 bg-fuchsia-400 space-y-2 rounded-lg border-none ">
    <h5 className="text-xl font-bold text-black">Expense Fee : {totalPrice}$</h5>
	</div>
    <button  className="btn w-full mt-10 text-black border-none  transition-all duration-300 hover:bg-gray-500 text-xl bg-fuchsia-500 shadow-xl">Pay Now</button>
</div>
        </div>
        </>
    );
